...
--
/*!50003 DROP PROCEDURE IF EXISTS `searchArticleByCategory` */;
...
DELIMITER ;;
CREATE DEFINER=`91031442`@`%` PROCEDURE `searchArticleByCategory`(cat VARCHAR(20))
BEGIN
SELECT c.categoryName, a.titleName, a.about 
 FROM category c
...
/*!50003 DROP PROCEDURE IF EXISTS `searchArticleByKeyword` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
